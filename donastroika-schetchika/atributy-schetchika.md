...
| pub\_id | Необязательный | Идентификатор пользователя, который должен быть установлен площадкой. Указывается в коде скрипта счетчика в качестве параметров атрибута options. |
